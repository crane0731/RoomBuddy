package roombuddy.roombuddy.jpaservice.login;
...
import roombuddy.roombuddy.jpaservice.token.JpaTokenService;
...
public class JpaLoginService {
    ...
    private final JpaTokenService tokenService; //토큰 서비스
    ...
    private Member securityLogin(LoginRequestDto dto) {
        ...
        //로그인된 회원 정보 가져오기
        JpaCustomUserDetails userDetails = (JpaCustomUserDetails) authentication.getPrincipal();
